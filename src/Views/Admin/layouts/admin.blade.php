...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="stylesheet" href="/duan1-php/public/components/assets/modules/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="/duan1-php/public/components/assets/modules/fontawesome/css/all.min.css">
    {{--CSS LIB--}}
    <link rel="stylesheet" href="/duan1-php/public/components/assets/modules/jqvmap/dist/jqvmap.min.css">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <img alt="image"
                             src="data:image/jpeg;base64,{{$_SESSION['user']['image']}}"
                             class="rounded-circle mr-1" style="width: 40px; height: 40px">
                        <div class="d-sm-none d-lg-inline-block">Hi, {{$_SESSION['user']['username']}}</div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-title">Logged in 5 min ago</div>
                        <a href="admin/profile/{{$_SESSION['user']['id']}}" class="dropdown-item has-icon">
...
<!-- General JS Scripts -->
<script src="/duan1-php/public/components/assets/modules/jquery.min.js"></script>
<script src="/duan1-php/public/components/assets/modules/popper.js"></script>
<script src="/duan1-php/public/components/assets/modules/tooltip.js"></script>
<script src="/duan1-php/public/components/assets/modules/bootstrap/js/bootstrap.min.js"></script>
<script src="/duan1-php/public/components/assets/modules/nicescroll/jquery.nicescroll.min.js"></script>
<script src="/duan1-php/public/components/assets/modules/moment.min.js"></script>
<script src="/duan1-php/public/components/assets/js/stisla.js"></script>

<!-- JS Libraies -->
<script src="/duan1-php/public/components/assets/modules/jquery.sparkline.min.js"></script>
<script src="/duan1-php/public/components/assets/modules/chart.min.js"></script>
